...
while ($p = mysqli_fetch_array($pending_approvals)) {
   ...
   if ($hourdiff > 2) {
      ...
      $update = updatedb('d_users_primary', "proposal_status='1',supervisor='$supervisor_1'", "uid='$user'");
      echo "Proposal Pushed by system to the supervisors.student can not edit it now";
   } else {
