  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
      ...
      <div class="row wow fadeIn">
              ...
              <div class="card-body">  
               <table id="user_table" class="table table-bordered table-striped display" width=100%>
                <thead>
   ...
   <!-- Modal -->
    <?php
        ...
        if(isset($_GET['edit-proposal']))
              {
              $esid = $_GET['edit-user'];     $sid = decurl($esid);
                    ...
                    <label>Supervisor 1</label>
                        <select id="supervisor_1" class="form-control">
                         ...
                         while($g = mysqli_fetch_array($super))
                             {
                                $uid = $g['uid'];
                                $title = $g['title'];$title_name = fetchrow('d_title',"uid='$title'","name");
                                $f_name = $g['first_name'];
                                $l_name = $g['last_name'];
                                if($uid == $sup_1)
                                   {
