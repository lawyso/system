...
<div class="card">
  ...
  <div class="card-body box-body">
    <table id="c_tbl" class="table table-bordered table-striped display table-responsive-lg">
        ...
        var dataTable = $('#c_tbl').DataTable({
          ...
          "columnDefs": [{
            ...
            "render": function(data, type, row) {
              let rowID = row[5];
              return `<a href="details?courses&edit-course=${ rowID }"><i class="fa fa-edit" style="color:blue" title="Edit"></i></a> &nbsp;<span onclick=\"del_course('${ rowID }')\"><i class="fa fa-times text-red" style="color:red" title="Delete"></i></span>`
            },
            "targets": 5
