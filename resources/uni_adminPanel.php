...
$totalStudents = countotal('d_users_primary', "topic_id >'0' AND status='1'");
$pendingApprovals = countotal('d_topics', "status='0'");
$missingSups = countotal('d_users_primary', "supervisor_id='0' AND user_group='2' AND topic_id >'0' AND status='1'");
?>
<div class="row">
  <div class="col-lg-12">
