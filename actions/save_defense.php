...
$titleOk = input_length($project_title,12);if($titleOk == 0){die(errormes('Project Title is required'));exit();}
...
$defense_dateOk = input_length($defense_date,5);if($defense_dateOk == 0){die(errormes('Please specify the defense date'));exit();}
