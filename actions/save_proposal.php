...
$titleOk = input_length($title,12);if($titleOk == 0){die(errormes('Proposal Title is required'));exit();}

$area_studyOk = input_length($area_study,20);if($area_studyOk == 0){die(errormes('Please specify the area of study/research'));exit();}
            ...
            if($sid > 0)
                ...
                else
                {
                    ///________________________create new proposal
                            ...
                            if($create == 1)
                                {
                                echo sucmes('Concept Paper/Proposal Submitted Successfully');  
